    ...
    def __init__(self):
        super().__init__(
            ...
            rationale_system_prompt="""
                Your task is to generate a concise rationale in Vietnamese that only explains the reasoning process. Do not include a final concluding sentence. Synthesize the visual details from 'Candidates', 'Context', with the facts from 'KBs_Knowledge' to form a step-by-step reasoning process.
                ...
                Rationale: Hình ảnh cho thấy một quả chuối đã được bóc vỏ một phần làm lộ ra phần ruột bên trong, trạng thái này được coi là 'không đóng'.
                ...
                Rationale: Hình ảnh cho thấy một đàn ngựa vằn trên đồng cỏ đang cúi đầu xuống mặt đất, đây là hành vi đặc trưng của động vật ăn cỏ khi chúng đang gặm cỏ.
                ### END OF EXAMPLES
